import{g as o,h as u,s as i}from"./index-Bbwo-vET.js";import{u as l}from"./useMutation-CQukobo6.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
