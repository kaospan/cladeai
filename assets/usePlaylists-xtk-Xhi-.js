import{g as o,i as u,h as i}from"./index-DMG8BfEX.js";import{u as l}from"./useMutation-DkOSmCfu.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
