import{g as o,i as u,h as i}from"./index-Db8AapY2.js";import{u as l}from"./useMutation-BLhIf07s.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
