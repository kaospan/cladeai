import{g as o,i as u,h as i}from"./index-BsY6Inqp.js";import{u as l}from"./useMutation-UAymMBOK.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
